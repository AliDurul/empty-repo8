...
exports.SetToken = exports.generateUsername = void 0;
...
const SetToken = (user) => {
    ...
    const access = jsonwebtoken_1.default.sign(payload, process.env.ACCESS_KEY, { expiresIn: '30m' });
    const refresh = jsonwebtoken_1.default.sign({ _id: user._id }, process.env.REFRESH_KEY, { expiresIn: '3d' });
