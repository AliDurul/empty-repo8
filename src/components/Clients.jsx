  ...
  <section className={`${styles.flexCenter} my-4`}>
    ...
    >
      {/* <div className={`flex items-stretch flex-wrap w-full gap-x-16 gap-y-8`}> */}
        {clients.map((client) => (
          <SwiperSlide>
            <div key={client.id} className={`flex-1 ${styles.flexCenter} rounded-[20px] sm:min-w-[192px] min-w-[170px]  flex justify-between flex-col client-card px-6 py-5 h-96`}>
